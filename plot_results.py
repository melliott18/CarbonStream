...
if len(sys.argv) != 4:
    print("Usage: python plot_results.py <results_csv> <slo_latency> <slo_throughput>")
    sys.exit(1)

results_file = sys.argv[1]
slo_latency = int(sys.argv[2])
slo_throughput = int(sys.argv[3])
